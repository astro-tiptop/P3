...
python3 ./dataGeneratorBatch.py --ini='/home/omartin/Projects/APPLY/CODES/_ANN/dataGen/nirc2.ini' --mag=10 --addStat=0 --nPSFperFolder=1 --savePath='/home/omartin/Projects/APPLY/' > 'genStatus.txt'
